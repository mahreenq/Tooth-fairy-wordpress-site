			...
			<?php while(have_posts()):the_post(); ?>
		    	<div>
		            ...
		            <div class="height-50 width-100 flex direction-column justify-between" style="background: url('<?php echo $backgroundImg[0]; ?>'); background-size:cover;">
		                <div class="med-blue-bkg flex justify-start white-font width-75 padding-med blog-title-margin" >
		                    <h2> <?php the_title() ?> </h2>
		                </div>
		                <div class="white-font med-blue-bkg flex justify-end align-self-end">
