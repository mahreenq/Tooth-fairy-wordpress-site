<div class="padding-med text-center row">
  <?php $servicesTitle = get_post_meta( get_the_ID(), 'services-residential_2'); ?>
    	<h2 class="padding-bottom-med"><?php	print_r($servicesTitle[0]); ?> </h2>
...
?>
  ...
  if($i % 2 === 0){$group ="d-direction-row-reverse"; $content="d-text-end";}  ?>
      ...
      <div class="margin-auto width-100 <?php echo $content ?>">
			     <h3 class="yellow-font padding-bottom-med"><?php echo $services['title-res'];?></h3>
  ...
  $pricinglink = get_post_meta( get_the_ID(), 'service-prices'); ?>
      <a  href="#"><p class="padding-bottom-lg lg-blue-font"><?php	print_r($pricinglink[0]); ?> </p></a>
</div>
