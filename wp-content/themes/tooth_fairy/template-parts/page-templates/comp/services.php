...
<div class="flex">
<div><img src= "<?php echo $services['services_img']; ?>"></div>

		<div  class="flex direction-column">
		 <div class="flex">

			<div><h4 class="padding-left-med black-font show" data-toggle="service<?php echo $key ?>"><?php echo $services['services_subtitle'];?>
